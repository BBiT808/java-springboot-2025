...
@Service
// @RequiredArgsConstructor // Lombok에서 파라미터 포함된 생성자를 자동 생성!
public class AboutService {

    private final AboutRepository aboutRepository;

    // @RequiredArgsConstructor와 동시에 쓸 수 는 없음!
    ...
    public About getAbout() {
        ...
        // ID 값으로 또는 year 로 오름차순 정렬을 다시하고 할당
    ...
    public Optional<About> getAboutLatest() {
