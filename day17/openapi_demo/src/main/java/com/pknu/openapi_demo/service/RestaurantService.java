...
public class RestaurantService {
    ...
    // OpenAPI 호출
    public GetFoodKr fetchRestaurants(int pageNo) { // 데이터 리스트 넘기기
        ...
        try {
            ...
            urlBuilder.append("?serviceKey="
                    + "J470l4206vqbJdgBNBoIEuxZCvjuQUnlLTHq%2BDlppcj0qp7v4htHeINnZGG2ShwL5ThinqCvC211sEkgDltrgA%3D%3D");
