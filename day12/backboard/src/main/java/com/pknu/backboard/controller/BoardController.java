...
public class BoardController {
    ...
    public String postModify(@Valid BoardForm boardForm, BindingResult bindingResult, @PathVariable("bno") Long bno,
    ...
    public String getBoardLike(@PathVariable("bno") Long bno, Principal principal) {
        ...
        this.boardService.putBoardLike(board, member); // 좋아요 클릭한 사용자 추가

        return String.format("redirect:/board/detail/%s", bno); // 좋아요 클릭 후 상세페이지로 이동
    }
